...
export const SHIBA_CODE_HASH: string = '0x90a3a1bad7e4780d633819ae2733c843ccea24beeea021bb20411a4a6ee2fb87'; //FROM FACTORY pairCodeHash
...
export const SHIBASWAP_ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.ROPSTEN]: '',
  [ChainId.GÖRLI]: '',
  [ChainId.KOVAN]: '0x97549d48ae4C4E1DA70C177FD1464bC7202513A1', // Address for UniswapV2Router02 for Shibaswap
  [ChainId.FANTOM]: '',
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: '',
